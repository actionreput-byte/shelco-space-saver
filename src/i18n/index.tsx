...
const EN = {
  ...
  "shop.subtitle":
    "Warehouse racks, supermarket shelving and accessories in stock in Dar es Salaam. Request a quotation — free site survey and installation in Dar es Salaam.",
  "shop.order": "Order now",
  "shop.vat": "Quote on request",
  "shop.quote": "Request a quotation",
  ...
  "calc.price": "Recommended system",
  "calc.system": "Recommended system",
  "calc.quoteHint": "Book a free site visit for a written quotation.",
  ...
  "svc.sending": "Sending…",
  "svc.error": "Could not send. Please call +255 652 808 809.",
...
const SW: Record<keyof typeof EN, string> = {
  ...
  "shop.eyebrow": "Duka",
  "shop.title": "Bidhaa zetu",
  "shop.subtitle":
    "Rack za ghala, shelf za maduka na vifaa vinapatikana Dar es Salaam. Omba nukuu — ukaguzi wa eneo na ufungaji ni bure ndani ya Dar es Salaam.",
  "shop.order": "Agiza sasa",
  "shop.vat": "Nukuu kwa ombi",
  "shop.quote": "Omba nukuu",
  ...
  "calc.price": "Mfumo unaopendekezwa",
  "calc.system": "Mfumo unaopendekezwa",
  "calc.quoteHint": "Omba ukaguzi wa bure kupata nukuu ya maandishi.",
  ...
  "svc.sending": "Inatuma…",
  "svc.error": "Imeshindikana kutuma. Tafadhali piga +255 652 808 809.",
