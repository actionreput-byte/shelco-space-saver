...
export function WhatsAppFab() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.94 }}
      className="fixed bottom-4 left-4 z-50 inline-flex items-center gap-2 rounded-full bg-[#25D366] py-2 pl-2 pr-4 shadow-lg"
    >
      ...
      <span className="text-sm font-bold text-white">WhatsApp chat</span>
    </motion.a>
  );
}
